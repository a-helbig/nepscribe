...
gen_script <- function(datapath_conv, datapath_local, suf_version, dataformat, subformat, datalist, prio, english, set_missings, parallel, further_training, education, children, work_exp, unemp_exp){
      ...
      if(dataformat== "R" & subformat == "Harmonized Spell Format"){
        scripts <- c(
          ...
          "",
          "# !!!ATTENTION!!!" ,
          "# This is a basic data preparation script that generates a data set in a person-year-format by taking the NEPS SUF Biography file as a baseline. Edits to the script that fit your research project's needs are probably necessary and recommended.",
          "",
          "# Approach:",
          "",
          ...
          "",
          "# 2. Step: Load employment data set and join it to biography in order to get access to working hours variable. This variable will be used in step 5 for the prioritisation of parallel employment episodes.",
          "",
          "# 3. Step: Load the VocTrain data set and join it to the biography data set to access the vocational training type variable. This variable will also be used in the prioritisation process.",
          "",
          ...
          "",
          "# 5. Step: Spell prioritisation process. Sort the months of each respondent by determined spell order, main/side episode (descending), working hours (descending), employment duration (descending) and splink. You may edit this according to your research question(s).",
          "",
          "# 6. Step: Reduce rows in data set to interview date months by loading cohort profile and generating a month variable for each interview date. Then left join biography data by ID_t and month. This will lead to a data set with 1 row per wave of each respondent (what we call: 'person-year-data set').",
          "",
          ...
          "",
          "# Code might need new intendation and formatting: Try Strg+A and then Strg+Shift+A in RStudio.",
          "",
