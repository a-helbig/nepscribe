...
#' @keywords internal
#' @noRd
gen_script <- function(datapath_conv, datapath_local, suf_version, suf_version_short, dataformat, subformat, datalist, prio, english, set_missings, parallel, further_training, education, children, work_exp, unemp_exp){
  ...
  if(dataformat== "R" & subformat == "Harmonized Spell Format"){
    scripts <- c(
      ...
      "",
      "# 3. Step: Load the vocTrain dataset and join it to the biography dataset to access the vocational training type variable. This variable will also be used in the prioritisation process.",
      "",
