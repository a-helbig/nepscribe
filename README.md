...
combine life-course information stored in spell format with panel data
in a wave format.
...
[here](https://shiny2.wzb.eu/ahelbig/nepscribe/).

## Citation

If you use this package in your research, please consider citing it. We
...
If you prefer to run NEPScribe locally, you can install the package from
GitHub with:
