...
Alexander Helbig, Insa Grüttgen (2026). *nepscribe*. Shiny application to generate NEPS data preparation scripts in Stata and R. Version 0.3.2 [Computer software]. https://github.com/a-helbig/nepscribe
